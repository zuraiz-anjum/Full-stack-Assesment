...
urlpatterns = [
    ...
    path("shared/<uuid:share_token>/", SharedTripDetailView.as_view(), name="shared-trip-detail"),
    path("shared/<uuid:share_token>/pdf/", SharedTripPdfView.as_view(), name="shared-trip-pdf"),
